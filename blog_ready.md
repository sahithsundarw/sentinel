...
The 235B Qwen model scores the same as "always refuse" on Task 4. A 60-state tabular Q-learner — with no language understanding — reaches **0.9540** in 20 episodes.
